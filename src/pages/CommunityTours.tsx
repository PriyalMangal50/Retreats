  ...
  return (
    <div className="min-h-screen pt-28">
      ...
      <Hero
        ...
        subtitleOverride={(
'Transform your team dynamics with purposeful retreats that combine strategic planning, wellness, and immersive experiences'        )}
        showBadge={false}
      />
      <TrustedBy />
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-gray-600" style={{ fontFamily: 'Archivo, serif', fontSize: '16px', lineHeight: '22px' }}>
            ...
            <div className="w-full md:w-[60%] flex items-center">
              <div>
                <h3 style={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, fontSize: '40px', lineHeight: '48px', letterSpacing: '-4%', marginBottom: 12, color: '#ffffff', marginTop: '-8px' }}>
                  <span style={{ display: 'inline-block' }}>What’s Community&nbsp;</span>
                  <span style={{
                ...
                <p style={{ fontFamily: 'Lato, sans-serif', fontWeight: 400, fontStyle: 'normal', fontSize: '20px', lineHeight: '28px', letterSpacing: '-2%', color: '#ffffff' }}>
                  Lorem ipsum dolor sit amet consectetur. Hac maecenas accumsan et in enim. Phasellus tortor penatibus curabitur sodales dictumst. Pretium duis at nibh ipsum. Duis maecenas id massa volutpat mollis pretium nullam elit. Egestas amet cras convallis odio quis non consectetur.
                </p>
                <p style={{ fontFamily: 'Lato, sans-serif', fontWeight: 400, fontStyle: 'normal', fontSize: '20px', lineHeight: '28px', letterSpacing: '-2%', color: '#ffffff' }}>
                  Lorem ipsum dolor sit amet consectetur. Hac maecenas accumsan et in enim. Phasellus tortor penatibus curabitur sodales dictumst. Pretium duis at nibh ipsum.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {(() => {
              const featured = [
                ...
                {
                  img: images.programs[7] || images.image7,
                  price: '39,999',
                  duration: '6D/5N',
                ...
                },
                {
                  ...
                  price: '22,499',
                  duration: '3D/2N',
                  title: 'Village Immersion — Community Connect',
                  desc: 'Cultural exchanges, local homestays and community-led experiences.'
                },
                {
                  img: images.programs[7] || images.image7,
                  price: '34,999',
                  ...
                  desc: 'Guided nature walks, river rituals and restorative campsite evenings.'
                },
                {
                  img: images.programs[10] || images.image7,
                  price: '19,999',
                  duration: '2D/1N',
                  title: 'Weekend Reset — Mini Wellness Retreat',
                  desc: 'Short restorative program with yoga, massage and guided mindfulness.'
                }
              ];
